...
import MyChallengeVideo from '../../../src/Screens/MyChallenge/MyChallengeVideo';
...
const getTempComponent = props => {
  return <MyChallengeVideo {...props} />;
};

describe('[MyChallengeVideo] Test', () => {
  const props = {
    route: {
      name: 'MyVideo',
    },
  ...
  test('MyChallengeVideo snapshot', () => {
    jest.useFakeTimers();
