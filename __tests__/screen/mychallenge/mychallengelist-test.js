...
import MyChallengeList from '../../../src/Screens/MyChallenge/MyChallengeList';
...
const getTempComponent = props => {
  return <MyChallengeList {...props} />;
};

describe('[MyChallengeList] Test', () => {
  const props = {
    route: {
      name: 'MyChallenge',
    },
