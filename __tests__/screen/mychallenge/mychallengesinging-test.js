...
import MyChallengeSinging from '../../../src/Screens/MyChallenge/MyChallengeSinging';
...
const getTempComponent = props => {
  return <MyChallengeSinging {...props} />;
};

describe('[MyChallengeSinging] Test', () => {
  const props = {
    route: {
      name: 'MySinging',
    },
  ...
  test('MyChallengeSinging snapshot', () => {
    jest.useFakeTimers();
