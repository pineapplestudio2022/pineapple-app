...
import MyChallengeComposing from '../../../src/Screens/MyChallenge/MyChallengeComposing';
...
const getTempComponent = props => {
  return <MyChallengeComposing {...props} />;
};

describe('[MyChallengeComposing] Test', () => {
  const props = {
    route: {
      name: 'MyComposing',
    },
  ...
  test('MyChallengeComposing snapshot', () => {
    jest.useFakeTimers();
