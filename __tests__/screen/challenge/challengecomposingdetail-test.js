...
import ChallengeComposingDetail from '../../../src/Screens/Challenge/ChallengeComposingDetail';
...
const getTempComponent = props => {
  return <ChallengeComposingDetail {...props} />;
};

describe('[ChallengeComposingDetail] Test', () => {
  const props = {
    route: {
  ...
  test('ChallengeComposingDetail snapshot', () => {
    jest.useFakeTimers();
