...
import ChallengeSinging from '../../../src/Screens/Challenge/ChallengeSinging';
...
const getTempComponent = props => {
  return <ChallengeSinging {...props} />;
};

describe('[ChallengeSinging] Test', () => {
  const props = {
    route: {
      name: 'Singing',
    },
  ...
  test('ChallengeSinging snapshot', () => {
    jest.useFakeTimers();
