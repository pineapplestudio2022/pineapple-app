...
import ChallengeListening from '../../../src/Screens/Challenge/ChallengeListening';
...
const getTempComponent = props => {
  return <ChallengeListening {...props} />;
};

describe('[ChallengeListening] Test', () => {
  const props = {
    route: {
      name: 'Listening',
      params: {
  ...
  test('ChallengeListening snapshot', () => {
    jest.useFakeTimers();
