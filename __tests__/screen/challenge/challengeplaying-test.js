...
import ChallengePlaying from '../../../src/Screens/Challenge/ChallengePlaying';
...
const getTempComponent = props => {
  return <ChallengePlaying {...props} />;
};

describe('[ChallengePlaying] Test', () => {
  const props = {
    route: {
      name: 'Playing',
    },
  ...
  test('ChallengePlaying snapshot', () => {
    jest.useFakeTimers();
