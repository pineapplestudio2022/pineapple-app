...
import ChallengeComposing from '../../../src/Screens/Challenge/ChallengeComposing';
...
const getTempComponent = props => {
  return <ChallengeComposing {...props} />;
};

describe('[ChallengeComposing] Test', () => {
  const props = {
    route: {
      name: 'Composing',
    },
  ...
  test('ChallengeComposing snapshot', () => {
    jest.useFakeTimers();
