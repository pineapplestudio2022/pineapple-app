...
import ChallengeLyricsView from '../../../src/Screens/Challenge/ChallengeLyricsView';
...
const getTempComponent = props => {
  return <ChallengeLyricsView {...props} />;
};

describe('[ChallengeLyricsView] Test', () => {
  const props = {
    route: {
      name: 'Lyrics',
      params: {
  ...
  test('ChallengeLyricsView snapshot', () => {
    jest.useFakeTimers();
