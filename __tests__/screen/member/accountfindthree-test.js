...
import AccountFindThree from '../../../src/Screens/Member/AccountFindThree';
...
const getTempComponent = props => {
  return <AccountFindThree {...props} />;
};

describe('[AccountFindThree] Test', () => {
  const props = {
    route: {
      params: {
        email: 'test@idealbloom.io',
      },
    },
  };
  const component = getTempComponent(props);
  test('AccountFindThree snapshot', () => {
    jest.useFakeTimers();
